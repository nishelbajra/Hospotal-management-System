...
const AppointmentForm = () => {
  ...
  // Pre-populate doctor and department from URL parameters
  useEffect(() => {
    const doctorId = searchParams.get("doctorId");
    const departmentParam = searchParams.get("department");

    if (doctorId && departmentParam && doctors.length > 0) {
      ...
      if (selectedDoctor) {
        ...
        // If doctor not found but department is valid, just set department
        setDepartment(departmentParam);
      }
    }
